 ...
 * 字符串操作工具类
 * @author zhzhao
 * @version $Id: StringUtils.java, v 0.1 2017年6月22日 上午11:14:55 zhzhao Exp $
 */
public class StringUtils {
     ...
     * @return
     */
    public static String[] deDuplicateArr(String[] arr) {
     ...
     */
    private static boolean regionMatches(final CharSequence cs, final boolean ignoreCase,
     ...
     * @return the index where the search sequence was found
     */
    private static int lastIndexOf(final CharSequence cs, final CharSequence searchChar,
                                   final int start) {
